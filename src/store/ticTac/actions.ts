...
import { ICreateRoomChanel, IJoinMyGame, IPlayWithBot, IPlayWithOpponent, IStepHistory } from './types';
...
export const joinMyGame = (payload: IJoinMyGame) => action(AT.JOIN_MY_GAME, payload);
...
export const createRoomChanel = (payload: ICreateRoomChanel) => action(AT.CREATE_ROOM_CHANNEL, payload);
