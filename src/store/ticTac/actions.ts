...
import { IPlayWithBot, TStepHistory } from './types';
...
export const setStepHistory = (payload: TStepHistory) => action(AT.SET_STEP_HISTORY, payload);
export const createRoomChanel = () => action(AT.CREATE_ROOM_CHANNEL);
